...
f_sigma_list = [('uniform_5_10_1000', 0.5), ('uniform_5_10_1000', 0.1),
                ('uniform_5_50_1000', 0.5), ('uniform_5_50_1000', 0.1),
                ('uniform_5_100_1000', 0.5), ('uniform_5_100_1000', 0.1),
                ('uniform_20_50_1000', 0.5), ('uniform_20_50_1000', 0.1),
                ('uniform_20_100_1000', 0.5), ('uniform_20_100_1000', 0.1),]
...
f_sigma_list = [
                ('uniform_5_50_2000', 0.5), ('uniform_5_50_2000', 0.1),
                ('uniform_5_100_2000', 0.5), ('uniform_5_100_2000', 0.1),
                ('uniform_5_50_1000', 0.5), ('uniform_5_50_1000', 0.1),
                ('uniform_5_100_1000', 0.5), ('uniform_5_100_1000', 0.1),]
f_sigma_list = [
                ('exponential_5_100_2000', 0.5), ('exponential_5_100_2000', 0.1),
                ('exponential_5_100_1000', 0.5), ('exponential_5_100_1000', 0.1),]

f_sigma_list = [('uni_normal_5_100_2000', 0.5), ('uni_normal_5_100_2000', 0.1)]

###
comparison_list = [('conditioning', 'svd')]
...
# replication
replication_list = list(range(10))[:]
report_replication_list = replication_list# list(range(100))[:]
report_replication_list = replication_list[:10]
# implementation
